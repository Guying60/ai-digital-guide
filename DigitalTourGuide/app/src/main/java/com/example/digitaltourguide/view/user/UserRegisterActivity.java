...
public class UserRegisterActivity extends AppCompatActivity {
    ...
    private void doRegister() {
        ...
        // 2. 简单校验
        if (username.isEmpty() || password.isEmpty() || nickname.isEmpty() || confirmPassword.isEmpty()) {
        ...
        ApiService.getInstance().register(request).enqueue(new Callback<BaseResponse<RegisterResponse>>() {
            @Override
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (baseResponse.getCode() == 1 && baseResponse.getData() != null) {
                        ...
                        if (username == null) { // 兜底：防止data里username为null
                            Toast.makeText(UserRegisterActivity.this, "注册成功(用户名空)", Toast.LENGTH_SHORT).show();
                        } else {
                    ...
                    // 网络错误/状态码非2xx
                    Toast.makeText(UserRegisterActivity.this, "请求失败", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<BaseResponse<RegisterResponse>> call,
                                  @NonNull Throwable t) {
                // 网络异常
                Toast.makeText(UserRegisterActivity.this, "网络异常：" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
