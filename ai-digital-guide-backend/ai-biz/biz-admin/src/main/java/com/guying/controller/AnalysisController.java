...
public class AnalysisController {
    ...
    public Result<EmotionTrendVO> getEmotionTrend(@PathVariable Long attractionId, Integer days) {
    ...
    public Result<EmotionFocusCardVO> getEmotionFocusCard(@PathVariable Long attractionId, Integer days) {
    ...
    public Result<SuggestionVO> getAiServiceSuggestion(@PathVariable Long attractionId, Integer type) {
